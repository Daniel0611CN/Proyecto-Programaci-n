...
public class TransportCategoryDAO extends BasicDAO implements IDAO<TransportCategory, Integer> {
    ...
    public boolean createTable(String file) throws Exception {
        ...
        try {
            result = super.createTable(file != null ? file : "src/bdFiles/transportCategoryTable.txt");
    ...
    @Override
    public TransportCategory readItemFromFile(String fileName) throws Exception {
