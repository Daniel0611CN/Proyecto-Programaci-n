...
public class TransportExtraDao extends BasicDao implements IDAO<TransportExtra, Integer> {
	...
	public boolean createTable(String file) throws Exception {
		...
		try {
			result = super.createTable(file != null ? file : "org/viajes/BBDD/bdFiles/transportExtraTable.txt");
	...
	private TransportExtra readItemFromFile(String fileName) throws Exception {
