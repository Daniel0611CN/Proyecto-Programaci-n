...
public class LocationDao extends BasicDao implements IDAO<Location, Integer> {
	...
	public boolean createTable(String fileName) throws Exception {
		...
		try {
			result = super.createTable(fileName != null ? fileName : "org/viajes/BBDD/bdFiles/locationTable.txt");
	...
	private Location readItemFromFile(String fileName) throws Exception {
