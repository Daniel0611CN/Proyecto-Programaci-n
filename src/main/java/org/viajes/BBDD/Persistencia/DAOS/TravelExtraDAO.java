...
import org.viajes.BBDD.Persistencia.Models.TravelExtra;
...
public class TravelExtraDAO extends BasicDAO implements IDAO<TravelExtra, Integer> {
    ...
    public boolean createTable(String file) throws Exception {
        ...
        try {
            result = super.createTable(file != null ? file : "src/bdFiles/travelExtraTable.txt");
    ...
    @Override
    public TravelExtra readItemFromFile(String fileName) throws Exception {
